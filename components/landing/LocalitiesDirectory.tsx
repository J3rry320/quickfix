    ...
    <section className="py-16 lg:py-24 bg-mist-gray/60 border-b border-zinc-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-6 mb-12">
          ...
          <div className="inline-flex items-center gap-2 rounded-2xl bg-tech-slate px-5 py-3 text-clean-white shadow-md shrink-0">
            <Zap className="h-5 w-5 text-electric-amber" />
            <div>
              <p className="text-xs font-extrabold uppercase tracking-wider text-clean-white">
                {t("dispatchBadge")}
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {zones.map((zone, idx) => (
            <div
              key={idx}
              className="rounded-2xl bg-clean-white border border-zinc-200 p-6 shadow-xs flex flex-col justify-between hover:border-flash-orange/50 transition-colors"
            >
              <div>
              ...
              <div className="mt-4 pt-3 border-t border-zinc-100 text-xs font-bold text-flash-orange">
