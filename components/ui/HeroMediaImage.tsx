  ...
  return (
    ...
    >
      {hasValidSrc ? (
        <div className="relative w-full h-full">
          ...
          {badge && (
            <div className="absolute top-3.5 left-3.5 z-10">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-tech-slate/90 backdrop-blur-md px-3 py-1 text-[11px] font-extrabold uppercase tracking-wider text-clean-white shadow-md border border-clean-white/20">
        ...
        <div className="relative w-full h-full p-6 sm:p-8 flex flex-col justify-between bg-gradient-to-br from-mist-gray via-clean-white to-flash-orange/5 select-none overflow-hidden">
          ...
          <div className="flex items-center justify-between w-full relative z-10">
            {badge ? (
              ...
              <span className="inline-flex items-center gap-1 rounded-full bg-surface-hover/80 px-2.5 py-0.5 text-[10px] font-bold text-text-secondary">
          ...
          <div className="my-auto flex flex-col items-center justify-center text-center relative z-10 py-2">
            <div className="relative mb-3 flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-2xl bg-tech-slate text-clean-white shadow-lg border border-border-dark/40 group-hover:scale-105 transition-transform">
